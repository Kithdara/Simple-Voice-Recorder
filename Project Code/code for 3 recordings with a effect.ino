...
void recordHistory(){
  ...
  if (menu2==5 and menu2<=2*audiofile) {
    lcd.clear();
    lcd.print("play>>---3.wav--");
    lcd.setCursor(0, 1);
    lcd.print("    >>-3mod.wav-");
  }
  if (menu2==6 and menu2<=2*audiofile ){
    lcd.clear();
    lcd.print("    >>---3.wav--");
    lcd.setCursor(0, 1);
    lcd.print("play>>-3mod.wav-");
  }
  if (menu2>7){
    menu2=6;
  }
...
//    player.play("3.wav");
  ...
  if (menu2 == 6 and menu2<=2*audiofile ){
    downsample("3.wav","3mod.wav");
    lcd.clear();
    lcd.print("3mod.wav playing");
    lcd.setCursor(0, 1);
    lcd.print(">>>back");
//    player.setVolume(6);
//    player.play("3mod.wav");
  }
}
